...
public class movie {
    ...
    protected static boolean add(String name, String genre, String director, String length, String rating, String url) {
        ...
        File f = new File("D:\\Kuliah\\Ms. Deffa Rahadian\\Project Movie\\Movie Database\\MovieDatabase\\txt\\src/movieList.txt");
        FileReader fr = null;
    ...
    protected static boolean deleteMovieorRequest(String name, int type) {
        File f = null;
        if (type == 1) {
            f = new File("D:\\Kuliah\\Ms. Deffa Rahadian\\Project Movie\\Movie Database\\MovieDatabase\\txt\\src/movieList.txt");
        } else {
            f = new File("D:\\Kuliah\\Ms. Deffa Rahadian\\Project Movie\\Movie Database\\MovieDatabase\\txt\\src/movieRequest.txt");
        }
        FileReader fr = null;
        BufferedReader br = null;
        FileWriter FR = null;
        ...
        try {
            ...
            try {
                ...
                f.delete();
                if (type == 2) {
                    file.renameTo(new File("D:\\Kuliah\\Ms. Deffa Rahadian\\Project Movie\\Movie Database\\MovieDatabase\\txt\\src/movieRequest.txt"));
                } else {
                    file.renameTo(new File("D:\\Kuliah\\Ms. Deffa Rahadian\\Project Movie\\Movie Database\\MovieDatabase\\txt\\src/movieList.txt"));
                }
            } catch (IOException ex) {
    ...
    protected static void deleteRequest(String s) {
        File f = new File("D:\\Kuliah\\Ms. Deffa Rahadian\\Project Movie\\Movie Database\\MovieDatabase\\txt\\src/movieRequest.txt");
        FileReader fr = null;
        BufferedReader br = null;
        FileWriter FR = null;
        File file = new File("D:\\Kuliah\\Ms. Deffa Rahadian\\Project Movie\\Movie Database\\MovieDatabase\\txt\\src/mytext.txt");
